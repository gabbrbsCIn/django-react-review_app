...
from .views import (CreateAndSaveQuiz, RevisionManagerView, RevisionDestroyView, RevisionUpdateView,
    QuizListView, QuizDeleteView, ValidateQuizView, QuestionListView, ChoiceListView,
    LastQuizResultView, SaveQuizResultView
)

urlpatterns = [
    path('create-save-quiz', CreateAndSaveQuiz.as_view(), name='create-save-quiz'),
